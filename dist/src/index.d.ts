...
export declare function createHeartbeat<S>(ms?: number, dispatch?: Dispatch<Action>, predicate?: HeartbeatPredicate<S>, autostart?: boolean, name?: string): HeartbeatMiddleware;
